...
class Student(models.Model):
    ...
    group = models.CharField("Группа", max_length=200,null=True)
    keywords = models.TextField("Ключевые слова",null=True)
    teacher = models.CharField("Преподаватель", max_length=200,null=True)
    speciality = models.CharField("Специальность", max_length=200,null=True)
